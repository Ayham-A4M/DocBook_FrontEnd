...
const DeleteDoctorPopup = ({ setShowDeletePopUp, doctorId }) => {
    ...
    const deleteDoctor = (event) => {
        ...
        const response = handleDeleteDoctor(doctorId);
        if (response) {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-[3px]    flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
                ...
                <div className="p-6">
                    <p className="mb-4">
                        Are you sure you want to delete <span className="font-semibold">Dr. Alex</span>?
                    </p>
                        ...
                        <div className="flex">
                            ...
                            <div className="ml-3">
                                <p className="text-sm text-yellow-700">
                                    Warning: This action cannot be undone. Deleting this doctor will permanently remove
                                    their information and all related data (appointments, prescriptions, etc.).
                                </p>
                            </div>
                        </div>
                    </div>
